                ...
                <footer className="footer p-10 text-base-content">
                    ...
                    <form>
                        ...
                        <div className="relative">
                            <input
                                type="text"
                                className="input border-none focus:outline-none outline-none rounded-lg pl-10 w-full"
                            ...
                            <button className="w-full btn bg-transparent hover:bg-transparent focus:bg-transparent rounded-lg text-white outline-white ">Subscribe Now</button>
                        </div>
                    </form>
                </footer>
                <footer className="footer px-10 py-4 border-t text-white border-white">
